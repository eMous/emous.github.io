...
三元组顺序表又将和一些**元信息**一起保存在一个联合结构中以表示一个稀疏矩阵，这些基础信息包括：
...
<div style="text-align: center;"><img style="height:400px;width:;" alt="" title="" src="http://ss.showyoumycode.com/StaticData/Blog/TSMatrix/TS_Trans.png"></div>
...
<div style="text-align: center;"><img style="height:400px;width:;" alt="" title="" src="http://ss.showyoumycode.com/StaticData/Blog/TSMatrix/TSMatrix_trans_normal.gif"></div>
