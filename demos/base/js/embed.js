            ...
            (function analyseDemoFiles() {
                ...
                if (js_files.length == 0){
                    ...
                    for (var i = 0; i < js_files.length; i++) {
                        var iframe = createAnResultIframeToContainer(document.getElementById("js_viewer"), js_files[i]);
                    }
                }
                ...
                if (css_files.length == 0){
                    ...
                    for (var i = 0; i < css_files.length; i++) {
                        var iframe = createAnResultIframeToContainer(document.getElementById("css_viewer"), css_files[i]);
                    }
                }
                ...
                if (html_files.length != 0) {
                    ...
                    // Create iframes.
                    for (var i = 0; i < html_files.length; i++) {
                        var iframe = createAnResultIframeToContainer(document.getElementById("html_viewer"), html_files[i]);
                    }
                }
                ...
                if (others_files.length == 0){
                    ...
                    for (var i = 0; i < others_files.length; i++) {
                        var iframe = createAnResultIframeToContainer(document.getElementById("others_viewer"), others_files[i]);
                    }
                }
            }())
